...
class ContactController extends AbstractController
{
    ...
    #public function index(Request $request, MailerInterface $mailer): Response //injection de dependance 
    public function index(Request $request, MailerInterface $mailer, NotifierInterface $notifier):Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $notifier->send(new Notification('Message de confirmation.', ['browser']));

            return $this->redirectToRoute('app_nice_s_tuff');
